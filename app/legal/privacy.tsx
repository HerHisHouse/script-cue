        ...
        <>
            ...
            <SafeAreaView style={[styles.container, { backgroundColor: 'transparent' }]}>
                ...
                <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
                    ...
                    <Text style={[styles.sectionTitle, { color: onBg }]}>9. Servicios de Terceros</Text>

                    <Text style={[styles.subsectionTitle, { color: onBg }]}>9.1 Supabase</Text>
                    <Text style={[styles.paragraph, { color: onBg2 }]}>
                    ...
                    <Text style={[styles.subsectionTitle, { color: onBg }]}>9.2 APIs de IA (OpenAI, Elevenlabs, etc.)</Text>
                    <Text style={[styles.paragraph, { color: onBg2 }]}>
                    ...
                    <Text style={[styles.subsectionTitle, { color: onBg }]}>9.3 Datos no compartidos</Text>
                    <Text style={[styles.paragraph, { color: onBg2 }]}>
                    ...
                    <Text style={[styles.sectionTitle, { color: onBg }]}>10. Cambios en esta Política</Text>
                    <Text style={[styles.paragraph, { color: onBg2 }]}>
