          ...
          >
            ...
            >
              ...
              <View style={{ marginTop: 12, width: '100%' }}>
                <Text style={{ color: colors.textSecondary, fontSize: rf(14), marginBottom: 4, textAlign: 'center' }}>
                  Revisa, compara y selecciona:
                </Text>
                <Text style={{ color: colors.textSecondary, fontSize: rf(14), marginTop: 2, textAlign: 'center' }}>• Elige entre tus tomas guardadas</Text>
                <Text style={{ color: colors.textSecondary, fontSize: rf(14), marginTop: 2, textAlign: 'center' }}>• Selecciona tu favorita</Text>
                <Text style={{ color: colors.textSecondary, fontSize: rf(14), marginTop: 2, textAlign: 'center' }}>• Fija el tiempo de expiración</Text>
              </View>
            </TouchableOpacity>
          </ScrollView>
          </View>
