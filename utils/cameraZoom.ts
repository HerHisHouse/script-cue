...
/**
 * Fase A2 (ScriptCue-LAB) — correcciones sobre el primer intento (verificadas
 * en código fuente y en dispositivo real, iPhone 12 Pro):
 ...
 *
 * Solo se usa en iOS (ver VisionCameraView.tsx) — Android sigue con las
 * paradas fijas de expo-camera hasta validarse en LAB.
 */
